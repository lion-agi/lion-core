"""
Process inputs in batches asynchronously with customizable options.

This module provides the bcall function for batch processing of inputs with
retry logic, optional timing, concurrency, and throttling.
"""
