"""
Module for nested pop operation on dictionaries and lists.

This module provides a function to perform a nested pop operation
on dictionaries and lists, allowing for deep key/index access and removal.
"""
