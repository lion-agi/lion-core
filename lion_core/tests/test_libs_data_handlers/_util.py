...
class TestIsSameDtypeFunction(unittest.TestCase):
    ...
    def test_is_same_dtype_with_return_dtype(self):
        ...
        self.assertEqual(is_same_dtype([1, "2", 3], int, return_dtype=True), (False, int))
...
class TestIsStructureHomogeneousFunction(unittest.TestCase):
    ...
    def test_is_structure_homogeneous_with_return_type(self):
        self.assertEqual(is_structure_homogeneous({'a': {'b': 1}, 'c': {'d': 2}}, return_structure_type=True), (True, dict))
        self.assertEqual(is_structure_homogeneous({'a': {'b': 1}, 'c': [1, 2]}, return_structure_type=True), (False, None))
