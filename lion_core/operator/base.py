...
from lionabc import AbstractObserver
...
from lion_core.setting import DEFAULT_CHAT_CONFIG, TimedFuncCallConfig
...
class BaseOperator(AbstractObserver):
    ...
    async def operate(
        ...
        **kwargs,
        ...
        if actions and invoke_action and (tools is None or tools is True):
            tools = self.tools
    ...
    async def communicate(
        ...
        **kwargs,
        ...
        if invoke_action and (tools is None or tools is True):
            tools = self.tools
