...
from lion_core.settings import BASE_LION_FIELDS, ConverterRegistry, lion_category
...
@lion_category(
    abstraction_level="pydantic_model",
    functionality="base",
    ...
    parent_class=["Element"],
    filepath=["lion_core", "generic", "component.py"],
)
...
class BaseMail(Component): ...


class Mail(BaseMail): ...


class BaseMessage(BaseMail): ...
