...
def test_action_request_init_with_callable():
    ...
    assert request.request["function"] == "dummy_func"
...
def test_action_request_with_complex_arguments():
    ...
    assert request.request["arguments"] == complex_args
...
def test_action_request_unicode():
    ...
    assert request.request["arguments"] == unicode_args
...
def test_action_request_with_callable_and_kwargs():
    ...
    assert request.request["function"] == "func_with_kwargs"
    assert request.request["arguments"] == {"x": 1, "y": 2, "z": 3}
...
def test_action_request_with_very_deep_nesting():
    ...
    assert request.request["arguments"] == deep_args
...
def test_action_request_with_various_callables():
    ...
    for func in [normal_func, async_func]:
        ...
        assert isinstance(request.request["function"], str)
...
def test_action_request_max_arguments():
    ...
    assert len(request.request["arguments"]) == 1000
...
def test_action_request_various_data_types():
    ...
    assert request.request["arguments"] == args
